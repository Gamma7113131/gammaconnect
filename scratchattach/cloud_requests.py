...
class CloudRequests:
    ...
    def credit_check(self):
        try:
            ...
            if not ("gamma" in description or "gamma" in description or "gamma" in description or "gamma" in description):
            ...
            print("If you use CloudRequests, please credit Gamma and TimMcCool!")
