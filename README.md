Scratch API wrapper with support for almost all site features. Created by [Gamma](https://scratch.mit.edu/users/gamma7113131/).
...
```py
import gammaconnect as scratch3
...
- Allmost all code by TimMcCool and Gamma.
